...
{
	class BindDeclaration : BindElement
	{
		Field field;

		internal BindDeclaration(Field field) : this(field, null) {}

		internal BindDeclaration(Field field, IDictionary extendedProperties) : base(extendedProperties)
		{
			this.field = field;
			ParsePattern();
		}
		...
		public override string PatternString
		{
			get
			{
				return Pattern.DeclarationPattern;
			}
		}
